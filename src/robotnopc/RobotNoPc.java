...
import robotnopc.Cell.*;
/**
 *
 * @author Jeffrey Creighton
 */
public class RobotNoPc {
    ...
    private static void updateRobot(int direction) {
         ...
         * MOVE ROBOT HERE
         */
        int new_rewards = moveRobot(currentCell.getArmRot(), currentCell.getRakeRot());
        if(direction == 0){
    ...
    private static int moveRobot(int armRot, int rakeRot){
        int moved = 0;
